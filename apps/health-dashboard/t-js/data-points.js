...
// Calculate data points - mirrors backend logic
...
// Validate span - mirrors frontend validateSpan
function validateSpan(granularity, start, end, maxDataPoints = 800) {
...
const y1 = calculateDataPoints('year', '2020-01-01', '2020-01-01');
assert.strictEqual(y1, 1, 'Single year should be 1 point');
const y2 = calculateDataPoints('year', '2020-01-01', '2025-12-31');
...
const m1 = calculateDataPoints('month', '2020-01-01', '2020-01-01');
assert.strictEqual(m1, 1, 'Single month should be 1 point');
const m2 = calculateDataPoints('month', '2020-01-15', '2020-12-15');
assert.strictEqual(m2, 12, '12 months should be 12 points');
const m3 = calculateDataPoints('month', '2020-01-15', '2022-03-15');
...
const w1 = calculateDataPoints('week', '2026-06-18', '2026-09-12');
assert.strictEqual(w1, 13, '3-month range should be ~13 weeks');
assert(w1 <= 800, 'Should be under limit');
const w2 = calculateDataPoints('week', '2026-06-18', '2050-01-01');
...
const d1 = calculateDataPoints('day', '2026-06-18', '2026-06-18');
assert.strictEqual(d1, 1, 'Single day should be 1 point');
const d2 = calculateDataPoints('day', '2026-06-18', '2026-09-12');
assert.strictEqual(d2, 87, '3-month range should be 87 days');
const d3 = calculateDataPoints('day', '2026-06-18', '2050-01-01');
...
assert.strictEqual(validateSpan('week', '2026-06-18', '2026-09-12'), null, 'Valid week range should not error');
assert.strictEqual(validateSpan('month', '2020-01-15', '2022-03-15'), null, 'Valid month range should not error');
assert.strictEqual(validateSpan('year', '2020-01-01', '2050-12-31'), null, 'Valid year range should not error');
...
const err1 = validateSpan('week', '2026-06-18', '2050-01-01');
...
const err2 = validateSpan('day', '2026-06-18', '2050-01-01');
...
assert.strictEqual(validateSpan('auto', '2020-01-01', '2050-12-31'), null, 'Auto granularity should always pass');
...
const err3 = validateSpan('week', '2026-09-12', '2026-06-18');
...
assert.strictEqual(validateSpan('week', '', '2026-09-12'), null, 'Empty start should return null');
assert.strictEqual(validateSpan('week', '2026-06-18', ''), null, 'Empty end should return null');
...
const err4 = validateSpan('week', '2026-06-18', '2026-09-12', 5);
